...
const inviteEmployee = (req, res) => {
    models_1.User.create(Object.assign(Object.assign({}, req.body), { isVerified: false }))
        .then((data) => {
        const token = jsonwebtoken_1.default.sign({ id: data._id }, process.env.JWT_SECRET, { expiresIn: '24h' });
